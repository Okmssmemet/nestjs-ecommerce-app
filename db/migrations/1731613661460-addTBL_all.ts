...
export class AddTBLAll1731613661460 implements MigrationInterface {
  name = 'AddTBLAll1731613661460';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DO $$ BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'orders_status_enum') THEN
          CREATE TYPE "public"."orders_status_enum" AS ENUM('processing', 'shipped', 'delivered');
        END IF;
      END $$;`
    );
    ...
    // Create tables after enum types
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "orders" (
        ...
        "status" "public"."orders_status_enum" NOT NULL DEFAULT 'processing',
        "shippedAt" TIMESTAMP,
